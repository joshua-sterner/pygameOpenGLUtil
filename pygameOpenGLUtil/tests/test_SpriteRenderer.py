...
inverted_color_grid_image_path = str(Path(__file__).parent/"images/colorGridInverted.png")
...
def test_render_one_sprite():
    ...
    save_image("test_results/test_render_one_sprite.png")
    assert(is_rendered_image(expected_image))

def test_render_two_adjacent_sprites_from_same_spritemap():
    expected_image = load_image("test_render_two_adjacent_sprites_from_same_spritemap.png")
    ...
    sprite_renderer = SpriteRenderer(sprite_manager)
    sprite_renderer.render()
    save_image("test_results/test_render_two_adjacent_sprites_from_same_spritemap.png")
    assert(is_rendered_image(expected_image))

def test_render_two_adjacent_sprites_from_different_spritemaps():
    expected_image = load_image("test_render_two_adjacent_sprites_from_different_spritemaps.png")
    openGLTestSetup(256, 128)
    ...
    sprite_renderer = SpriteRenderer(sprite_manager)
    sprite_renderer.render()
    save_image("test_results/test_render_two_adjacent_sprites_from_different_spritemaps.png")
    assert(is_rendered_image(expected_image))
